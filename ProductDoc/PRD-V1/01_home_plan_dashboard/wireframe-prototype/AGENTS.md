...
- The plan-dashboard progress arc must use the same 15 px visual width as the track, with round caps at both ends and a green-at-start to yellow-at-end gradient. The three metric-item icons are fixed at 14 × 14, matching the title text height.
