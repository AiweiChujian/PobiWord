...
- The plan-dashboard progress arc must share the track's 104 × 104 bounds and use the same 15 px INSIDE stroke alignment, so it never exceeds or gets clipped by the ring container. Keep round caps at both ends and a clearly green-at-start to pure-yellow-at-end gradient.
- The upper-left dashboard metric is “易错词”, not “待学习”, and uses the red theme with a warning-triangle symbol. The “已掌握” check-circle and “预计完成日期” calendar symbols retain their blue-violet and orange themes. All three icon artworks use complete 14 × 14 square canvases.
